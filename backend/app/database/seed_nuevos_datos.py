    ...
    try:
        ...
        libros_nuevos = [
            ...
            dict(nombre="Drácula",                     isbn="9780141439846", autor="Bram Stoker",
                 ...
                 categoria_id=cat("FICCION").id,       editorial="Penguin Classics",    anio_publicacion=1897,
            ...
            dict(nombre="El arte de la guerra",        isbn="9780140455526", autor="Sun Tzu",
                 ...
                 categoria_id=cat("FILOSOFIA").id,     editorial="Penguin Classics",    anio_publicacion=500,
            ...
            dict(nombre="Atomic Habits",               isbn="9780735211292", autor="James Clear",
                 ...
                 categoria_id=cat("NO_FICCION").id,    editorial="Avery",               anio_publicacion=2018,
            ...
            dict(nombre="El nombre del viento",        isbn="9780756404741", autor="Patrick Rothfuss",
                 ...
                 categoria_id=cat("FICCION").id,       editorial="DAW Books",           anio_publicacion=2007,
            ...
            dict(nombre="Thinking, Fast and Slow",     isbn="9780374533557", autor="Daniel Kahneman",
                 ...
                 categoria_id=cat("NO_FICCION").id,    editorial="Farrar, Straus and Giroux", anio_publicacion=2011,
            ...
            dict(nombre="Estructura y algoritmos de datos", isbn="9780131911932", autor="Mark Allen Weiss",
                 ...
                 categoria_id=cat("ACADEMICO").id,     editorial="Pearson",             anio_publicacion=2006,
            ...
            dict(nombre="Frankenstein",                isbn="9780141439471", autor="Mary Shelley",
                 ...
                 categoria_id=cat("FICCION").id,       editorial="Penguin Classics",    anio_publicacion=1818,
            ...
            dict(nombre="El túnel",                    isbn="9788423307937", autor="Ernesto Sabato",
                 ...
                 categoria_id=cat("FICCION").id,       editorial="Booket",              anio_publicacion=1948,
            ...
            dict(nombre="Inteligencia artificial: Un enfoque moderno", isbn="9780136042594",
                 ...
                 categoria_id=cat("TECNOLOGIA").id,    editorial="Prentice Hall",       anio_publicacion=2009,
            ...
            dict(nombre="La casa de los espíritus",    isbn="9788401242458", autor="Isabel Allende",
                 ...
                 categoria_id=cat("FICCION").id,       editorial="Plaza & Janés",       anio_publicacion=1982,
