...
-- =====================================================
-- CATEGORÍAS DE LIBROS (necesarias antes de insertar libros)
-- =====================================================
INSERT INTO categorias_libro (name, description) VALUES
    ('FICCION',     'Novelas, cuentos y literatura de ficción'),
    ('NO_FICCION',  'Biografías, ensayos y literatura documental'),
    ('CIENCIA',     'Libros de ciencia y divulgación científica'),
    ('TECNOLOGIA',  'Programación, informática y tecnología'),
    ...
    ('ACADEMICO',   'Textos universitarios y académicos'),
    ('FILOSOFIA',   'Filosofía, ética y pensamiento');
...
VALUES (
    ...
    (SELECT id FROM categorias_libro WHERE name = 'FICCION'),
    'Vintage Español',
    1967,
    450.00,
    25,
...
VALUES (
    ...
    (SELECT id FROM categorias_libro WHERE name = 'TECNOLOGIA'),
    'Prentice Hall',
    2008,
    850.00,
    12,
...
VALUES (
    ...
    (SELECT id FROM categorias_libro WHERE name = 'ACADEMICO'),
    'McGraw-Hill',
    2010,
    780.00,
    6,
...
VALUES (
    ...
    (SELECT id FROM categorias_libro WHERE name = 'FILOSOFIA'),
    'Penguin Classics',
    180,
    290.00,
    14,
...
VALUES (
    ...
    (SELECT id FROM categorias_libro WHERE name = 'NO_FICCION'),
    'Simon & Schuster',
    2011,
    550.00,
    16,
